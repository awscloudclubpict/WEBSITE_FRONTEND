...
export default function SignUpStudent() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0F1419]">
      {/* Header */}
      <header className="w-full px-6 py-4 flex justify-center">
        <div className="max-w-4xl w-full flex items-center justify-between">
          ...
          <h2 className="text-white text-lg font-medium text-center flex-1">
            Sign Up Page - student only
          </h2>
          <div className="w-24"></div>
        </div>
      </header>
      ...
      <main className="flex flex-col items-center justify-center flex-1 w-full">
        <div className="w-full max-w-md mx-auto bg-transparent py-12 px-8 rounded-xl">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-white mb-2">Sign Up</h1>
            <p className="text-[#3498DB] text-lg">Join a community of cloud enthusiasts</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                value={formData.userType}
                onChange={handleInputChange}
                className="w-full px-4 py-3 bg-[#2C3E50] border border-gray-700 rounded-lg text-white focus:outline-none text-base"
              >
                <option value="Student">Student</option>
                <option value="Professional">Professional</option>
              </select>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Enter Your Password Here"
                  className="w-full px-4 py-3 bg-[#2C3E50] border border-gray-700 rounded-lg text-white focus:outline-none text-base pr-10"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
            ...
            <div>
              <button
                type="submit"
                className="w-full bg-[#3498DB] text-white py-3 px-6 rounded-lg font-medium hover:bg-[#2980B9] transition-colors text-base"
              >
                Sign Up
              </button>
            </div>
