...
//   static BASE_URL = "https://website-backend-lkns.onrender.com"; // your backend URL
...
export class BlogLoader {
  ...
  static dummyBlogs = [
    ...
    },
    {
      ...
      short_description:
        "Discover the basics of machine learning algorithms and their applications.",
    ...
    },
    {
      ...
      short_description:
        "A comprehensive guide to Amazon Web Services and cloud computing.",
    ...
    },
    {
      ...
      short_description:
        "How AI is transforming our daily lives and industries.",
      thumbnail_image_url: "/images/img_image.png",
    ...
    },
    {
      ...
      short_description:
        "Essential tips and best practices for React.js development.",
      thumbnail_image_url: "/images/img_image_4.png",
  ...
  static async loadAllTags() {
    try {
      ...
      const allTags = Array.from(
        new Set(this.dummyBlogs.flatMap((blog) => blog.tags || []))
      );
  ...
  static async addBlog(blogData) {
    try {
      ...
      const newBlog = {
        ...
        thumbnail_image_url:
          blogData.thumbnail_image_url || "/images/blog-placeholder-new.jpg",
      };
