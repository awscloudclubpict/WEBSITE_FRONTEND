  ...
  return (
    <div className="min-h-screen bg-[#060717] relative overflow-hidden">
      ...
      <div className="absolute left-4 sm:left-6 lg:left-10 top-4 z-50">
        <img className="w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 object-contain" src="/logo.png" />
      </div>
      ...
      <div className="relative min-h-screen grid place-items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 w-full max-w-md sm:max-w-lg lg:max-w-2xl xl:max-w-3xl">
          ...
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <h1 className="text-white text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">Log In</h1>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <div className="block text-white text-lg sm:text-xl lg:text-2xl font-bold mb-1">
                Email Address
              </div>
              <input
                type="email"
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 accent-[#327ED7] bg-gray-800 border-gray-900 rounded focus:ring-blue-500 focus:ring-2"
              />
              <div className="ml-3 text-white text-base sm:text-lg font-extralight">
                Remember Me
              </div>
            </div>
        ...
        <div className="pointer-events-none absolute top-1/2 -translate-y-1/2 left-1/2 translate-x-8 sm:translate-x-16 lg:translate-x-32 xl:translate-x-48 hidden lg:block w-48 xl:w-64 2xl:w-80">
          <img className="w-full h-full object-contain" src="/Sample.png" />
        </div>
      </div>
    </div>
  );
